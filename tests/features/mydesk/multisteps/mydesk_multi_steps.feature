...
Scenario: Login to MyDesk
  ...
  And I fill in element "input[placeholder="Nom d'utilisateur"]" with value "{settings:username}"
  And I fill in element "input[placeholder="Mot de passe"]" with value "{settings:password}"
